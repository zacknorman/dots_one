...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(59), __webpack_require__(155).setImmediate))
...
// add the styles to the DOM
var add = __webpack_require__(4).default
var update = add("55c01fd8", content, false, {});
// Hot Module Replacement
if(false) {}
...
// add the styles to the DOM
var add = __webpack_require__(4).default
var update = add("5a4065f4", content, false, {});
// Hot Module Replacement
if(false) {}
...
vue_runtime_esm["a" /* default */].use(vuex_esm);
function log(level, message) {
...
function makeReviewModule(popupState, storageContents) {
        ...
        _a[Getters.MEETS_REVIEW_CRITERIA] = function (state) {
            if (state.reviewDate !== undefined || state.reviewCloseDate !== undefined) {
                ...
                if (state.reviewPostponeDate === undefined) {
                    if (utils["c" /* dateOlderThan */](state.installDate, 1) && dataCriteria(state.isFullVersion, state.dataAllowed, state.dataCap)) {
                        return true;
                    }
                    else {
                        return false;
                    ...
                    if (utils["c" /* dateOlderThan */](state.reviewPostponeDate, 30)) {
                        return true;
                    }
                }
            }
    ...
    var actions = (_c = {},
        _c[Actions.POSTPONE_REVIEW] = function (context) {
            ...
            var time = Date.now();
            utils["o" /* storageSet */]("reviewPostpone", time);
        ...
        _c[Actions.CLOSE_REVIEW] = function (context) {
            ...
            var time = Date.now();
            utils["o" /* storageSet */]("reviewClose", time);
        ...
        _c[Actions.OPEN_EXTENSION_STORE] = function (context) {
            ...
            var time = Date.now();
            utils["o" /* storageSet */]("review", time);
...
(function (Getters) {
    ...
    Getters["IS_SHOWING_REMEMBEAR"] = "IS_SHOWING_REMEMBEAR";
...
(function (Mutations) {
    ...
    Mutations["SET_CAN_SHOW_REMEMBEAR"] = "SET_CAN_SHOW_REMEMBEAR";
...
(function (Actions) {
    ...
    Actions["CLOSE_REMEMBEAR"] = "CLOSE_REMEMBEAR";
    Actions["GET_REMEMBEAR"] = "GET_REMEMBEAR";
...
var popup_vm_PopupState = /** @class */ (function () {
    function PopupState() {
        ...
        // Browser/system info
        this.browserTitle = utils["e" /* getBrowserTitle */]();
        this.isRetinaScreen = utils["k" /* isScreenRetina */]();
        this.platformClass = utils["i" /* getPlatformClass */]();
        // Account parameters
        ...
        //RememBear Prompt
        this.canShowRememBearPrompt = false;
        // Country info
        ...
        // Current month
        this.currentMonth = utils["h" /* getMonthString */]();
        // Location Info
...
function makePopupVM(storageContents, reviewModule) {
    ...
    var getters = (_a = {},
        ...
        _a[popup_vm_Getters.IS_SHOWING_REMEMBEAR] = function (state, getters) {
            return state.canShowRememBearPrompt === true &&
                getters[popup_vm_Getters.IS_SHOWING_TWITTER] === false &&
                getters[REVIEW_NAMESPACE + Getters.SHOWING_REVIEW_SCREEN] === false;
        },
    ...
    var mutations = (_b = {},
        ...
        _b[popup_vm_Mutations.SET_TWITTER_PROMO] = function (state, twitterPromo) { return state.twitterPromo = twitterPromo; },
        _b[popup_vm_Mutations.SET_TWITTER_PROMO_ENABLED] = function (state, twitterPromoEnabled) { return state.twitterPromoEnabled = twitterPromoEnabled; },
        ...
        _b[popup_vm_Mutations.SET_CAN_SHOW_REMEMBEAR] = function (state, canShowRememBear) { return state.canShowRememBearPrompt = canShowRememBear; },
        _b);
    var actions = (_c = {},
        // Toggle on/off
        ...
        _c[popup_vm_Actions.TOGGLE_MAP_COLLAPSE] = function (context) {
            ...
            utils["o" /* storageSet */]("popupCollapsed", newMapCollapseState);
        },
        // Change country
        ...
        _c[popup_vm_Actions.DISMISS_DOUBLE_TUNNEL] = function (context, doNotWarn) {
            ...
            utils["o" /* storageSet */]("doubleTunnelDismiss", time);
            if (doNotWarn === true) {
                context.commit(popup_vm_Mutations.SET_DOUBLE_TUNNEL_DO_NOT_WARN, true);
                utils["o" /* storageSet */]("doubleTunnelDoNotWarn", true);
            }
        },
        //RememBear prompt
        _c[popup_vm_Actions.GET_REMEMBEAR] = function () {
            popup_vm_log(logger["a" /* Level */].DEBUG, "[Popup] : get-remembear clicked");
            ports["c" /* sendMessage */](ports["a" /* PortName */].SETTINGS, "get-remembear");
        },
        _c[popup_vm_Actions.CLOSE_REMEMBEAR] = function () {
            popup_vm_log(logger["a" /* Level */].DEBUG, "[Popup] : close-remembear clicked");
            ports["c" /* sendMessage */](ports["a" /* PortName */].SETTINGS, "close-remembear");
        },
        _c);
    return new vuex_esm.Store({
        state: state,
        getters: getters,
        mutations: mutations,
        actions: actions,
...
VueRouter.prototype.init = function init (app /* Vue component instance */) {
  ...
  "production" !== 'production' && vue_router_esm_assert(
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/app.vue?vue&type=template&id=7fc237b5
var render = function() {
  var _vm = this
...
// CONCATENATED MODULE: ./src/popup/app.vue?vue&type=template&id=7fc237b5

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/error-screen/error-screen.vue?vue&type=template&id=0120c23a&scoped=true
var error_screenvue_type_template_id_0120c23a_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
var error_screenvue_type_template_id_0120c23a_scoped_true_staticRenderFns = []
error_screenvue_type_template_id_0120c23a_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/error-screen/error-screen.vue?vue&type=template&id=0120c23a&scoped=true
...
/* harmony default export */ var error_screenvue_type_script_lang_js = ({
  name: "ErrorScreen",
  computed: {
...
// CONCATENATED MODULE: ./src/popup/error-screen/error-screen.vue?vue&type=script&lang=js
 /* harmony default export */ var error_screen_error_screenvue_type_script_lang_js = (error_screenvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/error-screen/error-screen.vue?vue&type=style&index=0&id=0120c23a&scoped=true&lang=css
var error_screenvue_type_style_index_0_id_0120c23a_scoped_true_lang_css = __webpack_require__(152);
...
var component = normalizeComponent(
  error_screen_error_screenvue_type_script_lang_js,
  error_screenvue_type_template_id_0120c23a_scoped_true_render,
  error_screenvue_type_template_id_0120c23a_scoped_true_staticRenderFns,
  false,
  null,
  "0120c23a",
  null
...
// CONCATENATED MODULE: ./src/popup/app.vue?vue&type=script&lang=js
 /* harmony default export */ var popup_appvue_type_script_lang_js = (appvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/app.vue?vue&type=style&index=0&lang=css
var appvue_type_style_index_0_lang_css = __webpack_require__(150);
...
var app_component = normalizeComponent(
  popup_appvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
app_component.options.__file = "src/popup/app.vue"
/* harmony default export */ var app = (app_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/main-screen.vue?vue&type=template&id=6fce4205
var main_screenvue_type_template_id_6fce4205_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var main_screenvue_type_template_id_6fce4205_staticRenderFns = []
main_screenvue_type_template_id_6fce4205_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/main-screen.vue?vue&type=template&id=6fce4205

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/top-row/top-row.vue?vue&type=template&id=40f823ba&scoped=true
var top_rowvue_type_template_id_40f823ba_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var top_rowvue_type_template_id_40f823ba_scoped_true_staticRenderFns = []
top_rowvue_type_template_id_40f823ba_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/top-row/top-row.vue?vue&type=template&id=40f823ba&scoped=true

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/top-row/expand-collapse-toggle.vue?vue&type=template&id=15af3d99&scoped=true
var expand_collapse_togglevue_type_template_id_15af3d99_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var expand_collapse_togglevue_type_template_id_15af3d99_scoped_true_staticRenderFns = []
expand_collapse_togglevue_type_template_id_15af3d99_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/top-row/expand-collapse-toggle.vue?vue&type=template&id=15af3d99&scoped=true
...
/* harmony default export */ var expand_collapse_togglevue_type_script_lang_js = ({
...
// CONCATENATED MODULE: ./src/popup/main-screen/top-row/expand-collapse-toggle.vue?vue&type=script&lang=js
 /* harmony default export */ var top_row_expand_collapse_togglevue_type_script_lang_js = (expand_collapse_togglevue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/top-row/expand-collapse-toggle.vue?vue&type=style&index=0&id=15af3d99&scoped=true&lang=css
var expand_collapse_togglevue_type_style_index_0_id_15af3d99_scoped_true_lang_css = __webpack_require__(144);
...
var expand_collapse_toggle_component = normalizeComponent(
  top_row_expand_collapse_togglevue_type_script_lang_js,
  expand_collapse_togglevue_type_template_id_15af3d99_scoped_true_render,
  expand_collapse_togglevue_type_template_id_15af3d99_scoped_true_staticRenderFns,
  false,
  null,
  "15af3d99",
  null
...
/* hot reload */
if (false) { var expand_collapse_toggle_api; }
expand_collapse_toggle_component.options.__file = "src/popup/main-screen/top-row/expand-collapse-toggle.vue"
/* harmony default export */ var expand_collapse_toggle = (expand_collapse_toggle_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/top-row/on-off-toggle.vue?vue&type=template&id=e7493d10&scoped=true
var on_off_togglevue_type_template_id_e7493d10_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var on_off_togglevue_type_template_id_e7493d10_scoped_true_staticRenderFns = []
on_off_togglevue_type_template_id_e7493d10_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/top-row/on-off-toggle.vue?vue&type=template&id=e7493d10&scoped=true
...
/* harmony default export */ var on_off_togglevue_type_script_lang_js = ({
  name: "OnOffToggle",
  data: function () {
    return {
      clicked: false
...
// CONCATENATED MODULE: ./src/popup/main-screen/top-row/on-off-toggle.vue?vue&type=script&lang=js
 /* harmony default export */ var top_row_on_off_togglevue_type_script_lang_js = (on_off_togglevue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/top-row/on-off-toggle.vue?vue&type=style&index=0&id=e7493d10&scoped=true&lang=css
var on_off_togglevue_type_style_index_0_id_e7493d10_scoped_true_lang_css = __webpack_require__(142);
...
var on_off_toggle_component = normalizeComponent(
  top_row_on_off_togglevue_type_script_lang_js,
  on_off_togglevue_type_template_id_e7493d10_scoped_true_render,
  on_off_togglevue_type_template_id_e7493d10_scoped_true_staticRenderFns,
  false,
  null,
  "e7493d10",
  null
...
/* hot reload */
if (false) { var on_off_toggle_api; }
on_off_toggle_component.options.__file = "src/popup/main-screen/top-row/on-off-toggle.vue"
/* harmony default export */ var on_off_toggle = (on_off_toggle_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/top-row/country-and-status.vue?vue&type=template&id=a1c68cd2&scoped=true
var country_and_statusvue_type_template_id_a1c68cd2_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
var country_and_statusvue_type_template_id_a1c68cd2_scoped_true_staticRenderFns = []
country_and_statusvue_type_template_id_a1c68cd2_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/top-row/country-and-status.vue?vue&type=template&id=a1c68cd2&scoped=true
...
/* harmony default export */ var country_and_statusvue_type_script_lang_js = ({
  name: "CountryAndStatus",
  computed: mapState({
    statusText: state => state.isToggled ? "Connected" : "Disconnected",
    countryText: state => Object(utils["g" /* getCountryName */])(state.selectedCountry.iso)
  }),
  methods: {
...
// CONCATENATED MODULE: ./src/popup/main-screen/top-row/country-and-status.vue?vue&type=script&lang=js
 /* harmony default export */ var top_row_country_and_statusvue_type_script_lang_js = (country_and_statusvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/top-row/country-and-status.vue?vue&type=style&index=0&id=a1c68cd2&scoped=true&lang=css
var country_and_statusvue_type_style_index_0_id_a1c68cd2_scoped_true_lang_css = __webpack_require__(140);
...
var country_and_status_component = normalizeComponent(
  top_row_country_and_statusvue_type_script_lang_js,
  country_and_statusvue_type_template_id_a1c68cd2_scoped_true_render,
  country_and_statusvue_type_template_id_a1c68cd2_scoped_true_staticRenderFns,
  false,
  null,
  "a1c68cd2",
  null
...
/* hot reload */
if (false) { var country_and_status_api; }
country_and_status_component.options.__file = "src/popup/main-screen/top-row/country-and-status.vue"
/* harmony default export */ var country_and_status = (country_and_status_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/top-row/settings-button.vue?vue&type=template&id=5f809d18&scoped=true
var settings_buttonvue_type_template_id_5f809d18_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var settings_buttonvue_type_template_id_5f809d18_scoped_true_staticRenderFns = []
settings_buttonvue_type_template_id_5f809d18_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/top-row/settings-button.vue?vue&type=template&id=5f809d18&scoped=true
...
/* harmony default export */ var settings_buttonvue_type_script_lang_js = ({
  name: "SettingsButton"
});

// CONCATENATED MODULE: ./src/popup/main-screen/top-row/settings-button.vue?vue&type=script&lang=js
 /* harmony default export */ var top_row_settings_buttonvue_type_script_lang_js = (settings_buttonvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/top-row/settings-button.vue?vue&type=style&index=0&id=5f809d18&scoped=true&lang=css
var settings_buttonvue_type_style_index_0_id_5f809d18_scoped_true_lang_css = __webpack_require__(137);
...
var settings_button_component = normalizeComponent(
  top_row_settings_buttonvue_type_script_lang_js,
  settings_buttonvue_type_template_id_5f809d18_scoped_true_render,
  settings_buttonvue_type_template_id_5f809d18_scoped_true_staticRenderFns,
  false,
  null,
  "5f809d18",
  null
...
/* hot reload */
if (false) { var settings_button_api; }
settings_button_component.options.__file = "src/popup/main-screen/top-row/settings-button.vue"
...
/* harmony default export */ var top_rowvue_type_script_lang_js = ({
  name: "TopRow",
  components: {
...
// CONCATENATED MODULE: ./src/popup/main-screen/top-row/top-row.vue?vue&type=script&lang=js
 /* harmony default export */ var top_row_top_rowvue_type_script_lang_js = (top_rowvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/top-row/top-row.vue?vue&type=style&index=0&id=40f823ba&scoped=true&lang=css
var top_rowvue_type_style_index_0_id_40f823ba_scoped_true_lang_css = __webpack_require__(135);
...
var top_row_component = normalizeComponent(
  top_row_top_rowvue_type_script_lang_js,
  top_rowvue_type_template_id_40f823ba_scoped_true_render,
  top_rowvue_type_template_id_40f823ba_scoped_true_staticRenderFns,
  false,
  null,
  "40f823ba",
  null
...
/* hot reload */
if (false) { var top_row_api; }
top_row_component.options.__file = "src/popup/main-screen/top-row/top-row.vue"
/* harmony default export */ var top_row = (top_row_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/middle-row.vue?vue&type=template&id=07d69374
var middle_rowvue_type_template_id_07d69374_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var middle_rowvue_type_template_id_07d69374_staticRenderFns = []
middle_rowvue_type_template_id_07d69374_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/middle-row.vue?vue&type=template&id=07d69374

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/map/connection-map.vue?vue&type=template&id=525d97d2&scoped=true
var connection_mapvue_type_template_id_525d97d2_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var connection_mapvue_type_template_id_525d97d2_scoped_true_staticRenderFns = []
connection_mapvue_type_template_id_525d97d2_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/connection-map.vue?vue&type=template&id=525d97d2&scoped=true

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/map/map-background.vue?vue&type=template&id=3dc4e1b8&scoped=true
var map_backgroundvue_type_template_id_3dc4e1b8_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
var map_backgroundvue_type_template_id_3dc4e1b8_scoped_true_staticRenderFns = []
map_backgroundvue_type_template_id_3dc4e1b8_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/map-background.vue?vue&type=template&id=3dc4e1b8&scoped=true
...
/* harmony default export */ var map_backgroundvue_type_script_lang_js = ({
  name: "MapBackground",
  computed: {
    isToggled: function () {
      return this.$store.state.isToggled
...
// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/map-background.vue?vue&type=script&lang=js
 /* harmony default export */ var map_map_backgroundvue_type_script_lang_js = (map_backgroundvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/map/map-background.vue?vue&type=style&index=0&id=3dc4e1b8&scoped=true&lang=css
var map_backgroundvue_type_style_index_0_id_3dc4e1b8_scoped_true_lang_css = __webpack_require__(131);
...
var map_background_component = normalizeComponent(
  map_map_backgroundvue_type_script_lang_js,
  map_backgroundvue_type_template_id_3dc4e1b8_scoped_true_render,
  map_backgroundvue_type_template_id_3dc4e1b8_scoped_true_staticRenderFns,
  false,
  null,
  "3dc4e1b8",
  null
...
/* hot reload */
if (false) { var map_background_api; }
map_background_component.options.__file = "src/popup/main-screen/middle-row/map/map-background.vue"
/* harmony default export */ var map_background = (map_background_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/map/map-origin.vue?vue&type=template&id=b4a9e7c8&scoped=true
var map_originvue_type_template_id_b4a9e7c8_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var map_originvue_type_template_id_b4a9e7c8_scoped_true_staticRenderFns = []
map_originvue_type_template_id_b4a9e7c8_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/map-origin.vue?vue&type=template&id=b4a9e7c8&scoped=true
...
/* harmony default export */ var map_originvue_type_script_lang_js = ({
  name: "MapOrigin",
  props: [ "position", "show" ],
  data: function () {
    return {
...
// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/map-origin.vue?vue&type=script&lang=js
 /* harmony default export */ var map_map_originvue_type_script_lang_js = (map_originvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/map/map-origin.vue?vue&type=style&index=0&id=b4a9e7c8&scoped=true&lang=css
var map_originvue_type_style_index_0_id_b4a9e7c8_scoped_true_lang_css = __webpack_require__(129);
...
var map_origin_component = normalizeComponent(
  map_map_originvue_type_script_lang_js,
  map_originvue_type_template_id_b4a9e7c8_scoped_true_render,
  map_originvue_type_template_id_b4a9e7c8_scoped_true_staticRenderFns,
  false,
  null,
  "b4a9e7c8",
  null
...
/* hot reload */
if (false) { var map_origin_api; }
map_origin_component.options.__file = "src/popup/main-screen/middle-row/map/map-origin.vue"
/* harmony default export */ var map_origin = (map_origin_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/map/map-tunnel.vue?vue&type=template&id=caad0744&scoped=true
var map_tunnelvue_type_template_id_caad0744_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", {
...
var map_tunnelvue_type_template_id_caad0744_scoped_true_staticRenderFns = []
map_tunnelvue_type_template_id_caad0744_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/map-tunnel.vue?vue&type=template&id=caad0744&scoped=true
...
/* harmony default export */ var map_tunnelvue_type_script_lang_js = ({
  name: "MapTunnel",
  props: [ "position", "show" ],
  computed: {
    positionStyle: function () {
...
// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/map-tunnel.vue?vue&type=script&lang=js
 /* harmony default export */ var map_map_tunnelvue_type_script_lang_js = (map_tunnelvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/map/map-tunnel.vue?vue&type=style&index=0&id=caad0744&scoped=true&lang=css
var map_tunnelvue_type_style_index_0_id_caad0744_scoped_true_lang_css = __webpack_require__(127);
...
var map_tunnel_component = normalizeComponent(
  map_map_tunnelvue_type_script_lang_js,
  map_tunnelvue_type_template_id_caad0744_scoped_true_render,
  map_tunnelvue_type_template_id_caad0744_scoped_true_staticRenderFns,
  false,
  null,
  "caad0744",
  null
...
/* hot reload */
if (false) { var map_tunnel_api; }
map_tunnel_component.options.__file = "src/popup/main-screen/middle-row/map/map-tunnel.vue"
/* harmony default export */ var map_tunnel = (map_tunnel_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/map/map-line.vue?vue&type=template&id=608a952c&scoped=true
var map_linevue_type_template_id_608a952c_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", {
...
var map_linevue_type_template_id_608a952c_scoped_true_staticRenderFns = []
map_linevue_type_template_id_608a952c_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/map-line.vue?vue&type=template&id=608a952c&scoped=true
...
/* harmony default export */ var map_linevue_type_script_lang_js = ({
  name: "MapLine",
...
// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/map-line.vue?vue&type=script&lang=js
 /* harmony default export */ var map_map_linevue_type_script_lang_js = (map_linevue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/map/map-line.vue?vue&type=style&index=0&id=608a952c&scoped=true&lang=css
var map_linevue_type_style_index_0_id_608a952c_scoped_true_lang_css = __webpack_require__(121);
...
var map_line_component = normalizeComponent(
  map_map_linevue_type_script_lang_js,
  map_linevue_type_template_id_608a952c_scoped_true_render,
  map_linevue_type_template_id_608a952c_scoped_true_staticRenderFns,
  false,
  null,
  "608a952c",
  null
...
/* hot reload */
if (false) { var map_line_api; }
map_line_component.options.__file = "src/popup/main-screen/middle-row/map/map-line.vue"
...
/* harmony default export */ var connection_mapvue_type_script_lang_js = ({
  name: "ConnectionMap",
  data: function () {
    return {
  ...
  computed: {
    ...
    tunnelText: function () {
      ...
      return utils["g" /* getCountryName */](this.$store.state.selectedCountry.iso)
    }
  },
  components: {
...
// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/map/connection-map.vue?vue&type=script&lang=js
 /* harmony default export */ var map_connection_mapvue_type_script_lang_js = (connection_mapvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/map/connection-map.vue?vue&type=style&index=0&id=525d97d2&scoped=true&lang=css
var connection_mapvue_type_style_index_0_id_525d97d2_scoped_true_lang_css = __webpack_require__(119);
...
var connection_map_component = normalizeComponent(
  map_connection_mapvue_type_script_lang_js,
  connection_mapvue_type_template_id_525d97d2_scoped_true_render,
  connection_mapvue_type_template_id_525d97d2_scoped_true_staticRenderFns,
  false,
  null,
  "525d97d2",
  null
...
/* hot reload */
if (false) { var connection_map_api; }
connection_map_component.options.__file = "src/popup/main-screen/middle-row/map/connection-map.vue"
/* harmony default export */ var connection_map = (connection_map_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/prompts/out-of-data-prompt.vue?vue&type=template&id=5b1020bc&scoped=true
var out_of_data_promptvue_type_template_id_5b1020bc_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
var out_of_data_promptvue_type_template_id_5b1020bc_scoped_true_staticRenderFns = []
out_of_data_promptvue_type_template_id_5b1020bc_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/out-of-data-prompt.vue?vue&type=template&id=5b1020bc&scoped=true
...
/* harmony default export */ var out_of_data_promptvue_type_script_lang_js = ({
  computed: {
...
// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/out-of-data-prompt.vue?vue&type=script&lang=js
 /* harmony default export */ var prompts_out_of_data_promptvue_type_script_lang_js = (out_of_data_promptvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/prompts/out-of-data-prompt.vue?vue&type=style&index=0&id=5b1020bc&scoped=true&lang=css
var out_of_data_promptvue_type_style_index_0_id_5b1020bc_scoped_true_lang_css = __webpack_require__(116);
...
var out_of_data_prompt_component = normalizeComponent(
  prompts_out_of_data_promptvue_type_script_lang_js,
  out_of_data_promptvue_type_template_id_5b1020bc_scoped_true_render,
  out_of_data_promptvue_type_template_id_5b1020bc_scoped_true_staticRenderFns,
  false,
  null,
  "5b1020bc",
  null
...
/* hot reload */
if (false) { var out_of_data_prompt_api; }
out_of_data_prompt_component.options.__file = "src/popup/main-screen/middle-row/prompts/out-of-data-prompt.vue"
/* harmony default export */ var out_of_data_prompt = (out_of_data_prompt_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/prompts/twitter-promo-prompt.vue?vue&type=template&id=6fdd2dce&scoped=true
var twitter_promo_promptvue_type_template_id_6fdd2dce_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var twitter_promo_promptvue_type_template_id_6fdd2dce_scoped_true_staticRenderFns = []
twitter_promo_promptvue_type_template_id_6fdd2dce_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/twitter-promo-prompt.vue?vue&type=template&id=6fdd2dce&scoped=true

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/prompts/prompt-box-helper.vue?vue&type=template&id=438df617&scoped=true
var prompt_box_helpervue_type_template_id_438df617_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
var prompt_box_helpervue_type_template_id_438df617_scoped_true_staticRenderFns = []
prompt_box_helpervue_type_template_id_438df617_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/prompt-box-helper.vue?vue&type=template&id=438df617&scoped=true
...
/* harmony default export */ var prompt_box_helpervue_type_script_lang_js = ({

});

// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/prompt-box-helper.vue?vue&type=script&lang=js
 /* harmony default export */ var prompts_prompt_box_helpervue_type_script_lang_js = (prompt_box_helpervue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/prompts/prompt-box-helper.vue?vue&type=style&index=0&id=438df617&scoped=true&lang=css
var prompt_box_helpervue_type_style_index_0_id_438df617_scoped_true_lang_css = __webpack_require__(112);
...
var prompt_box_helper_component = normalizeComponent(
  prompts_prompt_box_helpervue_type_script_lang_js,
  prompt_box_helpervue_type_template_id_438df617_scoped_true_render,
  prompt_box_helpervue_type_template_id_438df617_scoped_true_staticRenderFns,
  false,
  null,
  "438df617",
  null
...
/* hot reload */
if (false) { var prompt_box_helper_api; }
prompt_box_helper_component.options.__file = "src/popup/main-screen/middle-row/prompts/prompt-box-helper.vue"
...
/* harmony default export */ var twitter_promo_promptvue_type_script_lang_js = ({
  components: {
...
// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/twitter-promo-prompt.vue?vue&type=script&lang=js
 /* harmony default export */ var prompts_twitter_promo_promptvue_type_script_lang_js = (twitter_promo_promptvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/prompts/twitter-promo-prompt.vue?vue&type=style&index=0&id=6fdd2dce&scoped=true&lang=css
var twitter_promo_promptvue_type_style_index_0_id_6fdd2dce_scoped_true_lang_css = __webpack_require__(110);
...
var twitter_promo_prompt_component = normalizeComponent(
  prompts_twitter_promo_promptvue_type_script_lang_js,
  twitter_promo_promptvue_type_template_id_6fdd2dce_scoped_true_render,
  twitter_promo_promptvue_type_template_id_6fdd2dce_scoped_true_staticRenderFns,
  false,
  null,
  "6fdd2dce",
  null
...
/* hot reload */
if (false) { var twitter_promo_prompt_api; }
twitter_promo_prompt_component.options.__file = "src/popup/main-screen/middle-row/prompts/twitter-promo-prompt.vue"
/* harmony default export */ var twitter_promo_prompt = (twitter_promo_prompt_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/prompts/review-prompt.vue?vue&type=template&id=26268497&scoped=true
var review_promptvue_type_template_id_26268497_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var review_promptvue_type_template_id_26268497_scoped_true_staticRenderFns = []
review_promptvue_type_template_id_26268497_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/review-prompt.vue?vue&type=template&id=26268497&scoped=true
...
/* harmony default export */ var review_promptvue_type_script_lang_js = ({
  components: {
    "prompt-box-helper": prompt_box_helper
  },
  computed: {
...
// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/review-prompt.vue?vue&type=script&lang=js
 /* harmony default export */ var prompts_review_promptvue_type_script_lang_js = (review_promptvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/prompts/review-prompt.vue?vue&type=style&index=0&id=26268497&scoped=true&lang=css
var review_promptvue_type_style_index_0_id_26268497_scoped_true_lang_css = __webpack_require__(106);
...
var review_prompt_component = normalizeComponent(
  prompts_review_promptvue_type_script_lang_js,
  review_promptvue_type_template_id_26268497_scoped_true_render,
  review_promptvue_type_template_id_26268497_scoped_true_staticRenderFns,
  false,
  null,
  "26268497",
  null
...
/* hot reload */
if (false) { var review_prompt_api; }
review_prompt_component.options.__file = "src/popup/main-screen/middle-row/prompts/review-prompt.vue"
/* harmony default export */ var review_prompt = (review_prompt_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/prompts/email-not-confirmed-prompt.vue?vue&type=template&id=359c31af&scoped=true
var email_not_confirmed_promptvue_type_template_id_359c31af_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm._m(0)
}
var email_not_confirmed_promptvue_type_template_id_359c31af_scoped_true_staticRenderFns = [
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
...
email_not_confirmed_promptvue_type_template_id_359c31af_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/email-not-confirmed-prompt.vue?vue&type=template&id=359c31af&scoped=true
...
/* harmony default export */ var email_not_confirmed_promptvue_type_script_lang_js = ({
  
});

// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/email-not-confirmed-prompt.vue?vue&type=script&lang=js
 /* harmony default export */ var prompts_email_not_confirmed_promptvue_type_script_lang_js = (email_not_confirmed_promptvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/prompts/email-not-confirmed-prompt.vue?vue&type=style&index=0&id=359c31af&scoped=true&lang=css
var email_not_confirmed_promptvue_type_style_index_0_id_359c31af_scoped_true_lang_css = __webpack_require__(103);
...
var email_not_confirmed_prompt_component = normalizeComponent(
  prompts_email_not_confirmed_promptvue_type_script_lang_js,
  email_not_confirmed_promptvue_type_template_id_359c31af_scoped_true_render,
  email_not_confirmed_promptvue_type_template_id_359c31af_scoped_true_staticRenderFns,
  false,
  null,
  "359c31af",
  null
...
/* hot reload */
if (false) { var email_not_confirmed_prompt_api; }
email_not_confirmed_prompt_component.options.__file = "src/popup/main-screen/middle-row/prompts/email-not-confirmed-prompt.vue"
/* harmony default export */ var email_not_confirmed_prompt = (email_not_confirmed_prompt_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/prompts/double-tunnel-warning-prompt.vue?vue&type=template&id=267f64e0&scoped=true
var double_tunnel_warning_promptvue_type_template_id_267f64e0_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "double-tunnel-prompt-container" } }, [
    _c("div", { attrs: { id: "prompt-text" } }, [
      _vm._v(
        "The desktop app is already connected. Turning off this extension may speed up your bear-owsing."
      )
    ]),
    _vm._v(" "),
...
var double_tunnel_warning_promptvue_type_template_id_267f64e0_scoped_true_staticRenderFns = []
double_tunnel_warning_promptvue_type_template_id_267f64e0_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/double-tunnel-warning-prompt.vue?vue&type=template&id=267f64e0&scoped=true
...
/* harmony default export */ var double_tunnel_warning_promptvue_type_script_lang_js = ({
  data: function () {
    return {
      doNotWarn: false
    }
...
// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/double-tunnel-warning-prompt.vue?vue&type=script&lang=js
 /* harmony default export */ var prompts_double_tunnel_warning_promptvue_type_script_lang_js = (double_tunnel_warning_promptvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/prompts/double-tunnel-warning-prompt.vue?vue&type=style&index=0&id=267f64e0&scoped=true&lang=css
var double_tunnel_warning_promptvue_type_style_index_0_id_267f64e0_scoped_true_lang_css = __webpack_require__(100);
...
var double_tunnel_warning_prompt_component = normalizeComponent(
  prompts_double_tunnel_warning_promptvue_type_script_lang_js,
  double_tunnel_warning_promptvue_type_template_id_267f64e0_scoped_true_render,
  double_tunnel_warning_promptvue_type_template_id_267f64e0_scoped_true_staticRenderFns,
  false,
  null,
  "267f64e0",
  null
...
/* hot reload */
if (false) { var double_tunnel_warning_prompt_api; }
double_tunnel_warning_prompt_component.options.__file = "src/popup/main-screen/middle-row/prompts/double-tunnel-warning-prompt.vue"
/* harmony default export */ var double_tunnel_warning_prompt = (double_tunnel_warning_prompt_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/prompts/remembear-prompt.vue?vue&type=template&id=224c93ed&scoped=true
var remembear_promptvue_type_template_id_224c93ed_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "prompt-box-helper",
    { on: { "close-button-clicked": _vm.remembearClose } },
    [
      _c("p", { attrs: { id: "remembear-text" } }, [
        _vm._v("Enjoying TunnelBear?"),
        _c("br"),
        _vm._v("Try our password manager too.")
      ]),
      _vm._v(" "),
      _c(
        "div",
        { attrs: { id: "remembear-button" }, on: { click: _vm.getRememBear } },
        [_vm._v("Get RememBear")]
      ),
      _vm._v(" "),
      _c("img", {
        attrs: {
...
var remembear_promptvue_type_template_id_224c93ed_scoped_true_staticRenderFns = []
remembear_promptvue_type_template_id_224c93ed_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/remembear-prompt.vue?vue&type=template&id=224c93ed&scoped=true

// CONCATENATED MODULE: ./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/middle-row/prompts/remembear-prompt.vue?vue&type=script&lang=js
//
//
//
//
...
/* harmony default export */ var remembear_promptvue_type_script_lang_js = ({
  components: {
    "prompt-box-helper": prompt_box_helper
  },
  methods: {
    getRememBear () {
      this.$store.dispatch(popup_vm_Actions.GET_REMEMBEAR)
    },
    remembearClose () {
      this.$store.dispatch(popup_vm_Actions.CLOSE_REMEMBEAR)
    }
  }
});

// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/remembear-prompt.vue?vue&type=script&lang=js
 /* harmony default export */ var prompts_remembear_promptvue_type_script_lang_js = (remembear_promptvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/middle-row/prompts/remembear-prompt.vue?vue&type=style&index=0&id=224c93ed&scoped=true&lang=css
var remembear_promptvue_type_style_index_0_id_224c93ed_scoped_true_lang_css = __webpack_require__(98);

// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/prompts/remembear-prompt.vue
...
var remembear_prompt_component = normalizeComponent(
  prompts_remembear_promptvue_type_script_lang_js,
  remembear_promptvue_type_template_id_224c93ed_scoped_true_render,
  remembear_promptvue_type_template_id_224c93ed_scoped_true_staticRenderFns,
  false,
  null,
  "224c93ed",
  null
...
/* hot reload */
if (false) { var remembear_prompt_api; }
remembear_prompt_component.options.__file = "src/popup/main-screen/middle-row/prompts/remembear-prompt.vue"
/* harmony default export */ var remembear_prompt = (remembear_prompt_component.exports);
...
/* harmony default export */ var middle_rowvue_type_script_lang_js = ({
  name: "MiddleRow",
  components: {
    ...
    'remembear-prompt' : remembear_prompt
  },
  computed: {
    ...
    showDoubleTunnelWarning: function () {
      ...
      let previouslyWarned = (dismissDate === undefined) ? false : !utils["c" /* dateOlderThan */](dismissDate, 1)
      let doNotWarnAgain = this.$store.state.doubleTunnelDoNotWarn
      return isToggled && nativeClientConnected && !previouslyWarned && !doNotWarnAgain
    },
    ...
    showRememBearPrompt: function () {
      return this.$store.getters[popup_vm_Getters.IS_SHOWING_REMEMBEAR] === true 
      && this.$store.state.isEmailConfirmed === true
    }
  }
});

// CONCATENATED MODULE: ./src/popup/main-screen/middle-row/middle-row.vue?vue&type=script&lang=js
 /* harmony default export */ var middle_row_middle_rowvue_type_script_lang_js = (middle_rowvue_type_script_lang_js); 
...
var middle_row_component = normalizeComponent(
  middle_row_middle_rowvue_type_script_lang_js,
  middle_rowvue_type_template_id_07d69374_render,
  middle_rowvue_type_template_id_07d69374_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var middle_row_api; }
middle_row_component.options.__file = "src/popup/main-screen/middle-row/middle-row.vue"
/* harmony default export */ var middle_row = (middle_row_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/main-screen/bottom-row/bottom-row.vue?vue&type=template&id=49e98c98&scoped=true
var bottom_rowvue_type_template_id_49e98c98_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
var bottom_rowvue_type_template_id_49e98c98_scoped_true_staticRenderFns = []
bottom_rowvue_type_template_id_49e98c98_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/main-screen/bottom-row/bottom-row.vue?vue&type=template&id=49e98c98&scoped=true
...
/* harmony default export */ var bottom_rowvue_type_script_lang_js = ({
  name: "BottomRow",
  computed: {
...
// CONCATENATED MODULE: ./src/popup/main-screen/bottom-row/bottom-row.vue?vue&type=script&lang=js
 /* harmony default export */ var bottom_row_bottom_rowvue_type_script_lang_js = (bottom_rowvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/main-screen/bottom-row/bottom-row.vue?vue&type=style&index=0&id=49e98c98&scoped=true&lang=css
var bottom_rowvue_type_style_index_0_id_49e98c98_scoped_true_lang_css = __webpack_require__(95);
...
var bottom_row_component = normalizeComponent(
  bottom_row_bottom_rowvue_type_script_lang_js,
  bottom_rowvue_type_template_id_49e98c98_scoped_true_render,
  bottom_rowvue_type_template_id_49e98c98_scoped_true_staticRenderFns,
  false,
  null,
  "49e98c98",
  null
...
/* hot reload */
if (false) { var bottom_row_api; }
bottom_row_component.options.__file = "src/popup/main-screen/bottom-row/bottom-row.vue"
...
/* harmony default export */ var main_screenvue_type_script_lang_js = ({
  name: "MainScreen",
  components: {
    "top-row": top_row,
...
// CONCATENATED MODULE: ./src/popup/main-screen/main-screen.vue?vue&type=script&lang=js
 /* harmony default export */ var main_screen_main_screenvue_type_script_lang_js = (main_screenvue_type_script_lang_js); 
...
var main_screen_component = normalizeComponent(
  main_screen_main_screenvue_type_script_lang_js,
  main_screenvue_type_template_id_6fce4205_render,
  main_screenvue_type_template_id_6fce4205_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var main_screen_api; }
main_screen_component.options.__file = "src/popup/main-screen/main-screen.vue"
/* harmony default export */ var main_screen = (main_screen_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/countries-screen/countries-screen.vue?vue&type=template&id=d8d0d33a
var countries_screenvue_type_template_id_d8d0d33a_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var countries_screenvue_type_template_id_d8d0d33a_staticRenderFns = []
countries_screenvue_type_template_id_d8d0d33a_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/countries-screen/countries-screen.vue?vue&type=template&id=d8d0d33a

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/countries-screen/country-row.vue?vue&type=template&id=9bf6f856&scoped=true
var country_rowvue_type_template_id_9bf6f856_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
var country_rowvue_type_template_id_9bf6f856_scoped_true_staticRenderFns = []
country_rowvue_type_template_id_9bf6f856_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/countries-screen/country-row.vue?vue&type=template&id=9bf6f856&scoped=true
...
/* harmony default export */ var country_rowvue_type_script_lang_js = ({
  name: "CountryRow",
  props: ["country"],
  computed: {
    countryName: function () {
      return utils["g" /* getCountryName */](this.country.iso)
    },
  ...
  methods: {
    countryClicked: function () {
      if (this.$store.state.selectedCountry.iso !== this.country.iso) {
        this.$store.dispatch(popup_vm_Actions.CHANGE_COUNTRY_PRESSED, this.country.code)
...
// CONCATENATED MODULE: ./src/popup/countries-screen/country-row.vue?vue&type=script&lang=js
 /* harmony default export */ var countries_screen_country_rowvue_type_script_lang_js = (country_rowvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/countries-screen/country-row.vue?vue&type=style&index=0&id=9bf6f856&scoped=true&lang=css
var country_rowvue_type_style_index_0_id_9bf6f856_scoped_true_lang_css = __webpack_require__(92);
...
var country_row_component = normalizeComponent(
  countries_screen_country_rowvue_type_script_lang_js,
  country_rowvue_type_template_id_9bf6f856_scoped_true_render,
  country_rowvue_type_template_id_9bf6f856_scoped_true_staticRenderFns,
  false,
  null,
  "9bf6f856",
  null
...
/* hot reload */
if (false) { var country_row_api; }
country_row_component.options.__file = "src/popup/countries-screen/country-row.vue"
/* harmony default export */ var country_row = (country_row_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/menu-helper/menu-helper.vue?vue&type=template&id=5a2ba486&scoped=true
var menu_helpervue_type_template_id_5a2ba486_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
var menu_helpervue_type_template_id_5a2ba486_scoped_true_staticRenderFns = []
menu_helpervue_type_template_id_5a2ba486_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/menu-helper/menu-helper.vue?vue&type=template&id=5a2ba486&scoped=true
...
/* harmony default export */ var menu_helpervue_type_script_lang_js = ({
  name: "MenuHelper",
  methods: {
    backPressed () {
      this.$router.go(-1)
...
// CONCATENATED MODULE: ./src/popup/menu-helper/menu-helper.vue?vue&type=script&lang=js
 /* harmony default export */ var menu_helper_menu_helpervue_type_script_lang_js = (menu_helpervue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/menu-helper/menu-helper.vue?vue&type=style&index=0&id=5a2ba486&scoped=true&lang=css
var menu_helpervue_type_style_index_0_id_5a2ba486_scoped_true_lang_css = __webpack_require__(90);
...
var menu_helper_component = normalizeComponent(
  menu_helper_menu_helpervue_type_script_lang_js,
  menu_helpervue_type_template_id_5a2ba486_scoped_true_render,
  menu_helpervue_type_template_id_5a2ba486_scoped_true_staticRenderFns,
  false,
  null,
  "5a2ba486",
  null
...
/* hot reload */
if (false) { var menu_helper_api; }
menu_helper_component.options.__file = "src/popup/menu-helper/menu-helper.vue"
...
/* harmony default export */ var countries_screenvue_type_script_lang_js = ({
...
// CONCATENATED MODULE: ./src/popup/countries-screen/countries-screen.vue?vue&type=script&lang=js
 /* harmony default export */ var countries_screen_countries_screenvue_type_script_lang_js = (countries_screenvue_type_script_lang_js); 
...
var countries_screen_component = normalizeComponent(
  countries_screen_countries_screenvue_type_script_lang_js,
  countries_screenvue_type_template_id_d8d0d33a_render,
  countries_screenvue_type_template_id_d8d0d33a_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var countries_screen_api; }
countries_screen_component.options.__file = "src/popup/countries-screen/countries-screen.vue"
/* harmony default export */ var countries_screen = (countries_screen_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/settings-screen/settings-screen.vue?vue&type=template&id=6700c031&scoped=true
var settings_screenvue_type_template_id_6700c031_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var settings_screenvue_type_template_id_6700c031_scoped_true_staticRenderFns = []
settings_screenvue_type_template_id_6700c031_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/settings-screen/settings-screen.vue?vue&type=template&id=6700c031&scoped=true
...
/* harmony default export */ var settings_screenvue_type_script_lang_js = ({
  name: "SettingsScreen",
  computed: {
...
// CONCATENATED MODULE: ./src/popup/settings-screen/settings-screen.vue?vue&type=script&lang=js
 /* harmony default export */ var settings_screen_settings_screenvue_type_script_lang_js = (settings_screenvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/settings-screen/settings-screen.vue?vue&type=style&index=0&id=6700c031&scoped=true&lang=css
var settings_screenvue_type_style_index_0_id_6700c031_scoped_true_lang_css = __webpack_require__(88);
...
var settings_screen_component = normalizeComponent(
  settings_screen_settings_screenvue_type_script_lang_js,
  settings_screenvue_type_template_id_6700c031_scoped_true_render,
  settings_screenvue_type_template_id_6700c031_scoped_true_staticRenderFns,
  false,
  null,
  "6700c031",
  null
...
/* hot reload */
if (false) { var settings_screen_api; }
settings_screen_component.options.__file = "src/popup/settings-screen/settings-screen.vue"
/* harmony default export */ var settings_screen = (settings_screen_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/popup/shortcuts-screen/shortcuts-screen.vue?vue&type=template&id=03e10943&scoped=true
var shortcuts_screenvue_type_template_id_03e10943_scoped_true_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var shortcuts_screenvue_type_template_id_03e10943_scoped_true_staticRenderFns = []
shortcuts_screenvue_type_template_id_03e10943_scoped_true_render._withStripped = true


// CONCATENATED MODULE: ./src/popup/shortcuts-screen/shortcuts-screen.vue?vue&type=template&id=03e10943&scoped=true
...
/* harmony default export */ var shortcuts_screenvue_type_script_lang_js = ({
...
// CONCATENATED MODULE: ./src/popup/shortcuts-screen/shortcuts-screen.vue?vue&type=script&lang=js
 /* harmony default export */ var shortcuts_screen_shortcuts_screenvue_type_script_lang_js = (shortcuts_screenvue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/popup/shortcuts-screen/shortcuts-screen.vue?vue&type=style&index=0&id=03e10943&scoped=true&lang=css
var shortcuts_screenvue_type_style_index_0_id_03e10943_scoped_true_lang_css = __webpack_require__(86);
...
var shortcuts_screen_component = normalizeComponent(
  shortcuts_screen_shortcuts_screenvue_type_script_lang_js,
  shortcuts_screenvue_type_template_id_03e10943_scoped_true_render,
  shortcuts_screenvue_type_template_id_03e10943_scoped_true_staticRenderFns,
  false,
  null,
  "03e10943",
  null
...
/* hot reload */
if (false) { var shortcuts_screen_api; }
shortcuts_screen_component.options.__file = "src/popup/shortcuts-screen/shortcuts-screen.vue"
    ...
    return new vue_runtime_esm["a" /* default */]({
        ...
        mounted: function () {
            ...
            this.$nextTick()
                ...
                .then(Object(utils["d" /* delayPromise */])(25))
                .then(function (appHeight) {
                // In case the height changes...
                var newHeight = $app.getBoundingClientRect().height;
                $app.style.height = Math.max(appHeight, newHeight) + "px";
            })
                .then(Object(utils["d" /* delayPromise */])(200))
                .then(function () {
                $app.style.height = "";
                $app.style.overflow = "";
            });
...
function sortCountries(countries) {
    countries.sort(function (countryA, countryB) {
        var aName = utils["g" /* getCountryName */](countryA.iso);
        var bName = utils["g" /* getCountryName */](countryB.iso);
        if (aName < bName) {
            return -1;
        }
        else if (aName > bName) {
...
function onPopupStateMessage(message) {
    ...
    if (message.selectedCountry !== undefined && message.countries !== undefined) {
        ...
        popupVM.commit(popup_vm_Mutations.SET_COUNTRIES, sortCountries(message.countries));
    }
    // Email confirmed and full version
    popupVM.commit(popup_vm_Mutations.SET_EMAIL_CONFIRMED, message.emailConfirmed);
    popupVM.commit(popup_vm_Mutations.SET_FULL_VERSION, message.isFullVersion);
    // Twitter
    popupVM.commit(popup_vm_Mutations.SET_TWITTER_PROMO, message.twitterPromo);
    popupVM.commit(popup_vm_Mutations.SET_TWITTER_PROMO_ENABLED, message.twitterPromoEnabled);
    popupVM.commit(popup_vm_Mutations.SET_CAN_SHOW_TWITTER, message.canShowTwitter);
    // Data
    popupVM.commit(popup_vm_Mutations.SET_DATA_ALLOWED, message.dataAllowed);
    popupVM.commit(popup_vm_Mutations.SET_DATA_CAP, message.dataCap);
    // Permission error
    popupVM.commit(popup_vm_Mutations.SET_PERMISSIONS_ERROR, message.permissionsError);
    // See if we can show the review screen
    var isShowingTwitterPromo = popupVM.getters[popup_vm_Getters.IS_SHOWING_TWITTER];
    var canShowReviewPrompt = popupVM.getters[REVIEW_NAMESPACE + Getters.MEETS_REVIEW_CRITERIA];
    if (isShowingTwitterPromo === false && canShowReviewPrompt === true) {
        popupVM.dispatch(REVIEW_NAMESPACE + Actions.OPEN_REVIEW);
    }
    //RememBear prompt
    popupVM.commit(popup_vm_Mutations.SET_CAN_SHOW_REMEMBEAR, message.canShowRememBear);
}
...
var popupVue;
var popupVM;
var initialPopupStatePromise = browser.runtime.sendMessage(ports["a" /* PortName */].POPUP_STATE);
var storageContentsPromise = utils["n" /* storageGetAll */]();
Promise.all([initialPopupStatePromise, storageContentsPromise]).then(function (values) {
    ...
    ports["d" /* setup */](ports["a" /* PortName */].SETTINGS, onSettingsMessage);
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_shortcuts_screen_vue_vue_type_style_index_0_id_03e10943_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_settings_screen_vue_vue_type_style_index_0_id_6700c031_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_helper_vue_vue_type_style_index_0_id_5a2ba486_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_country_row_vue_vue_type_style_index_0_id_9bf6f856_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_bottom_row_vue_vue_type_style_index_0_id_49e98c98_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// module
exports.push([module.i, "\n#remembear-text[data-v-224c93ed] {\n  font-size: 14px;\n  color: #828282;\n  text-align: center;\n  margin: 0px;\n  padding-left: 8px;\n  padding-right: 74px;\n  padding-top: 30px;\n}\n#remembear-bear[data-v-224c93ed] {\n  position: absolute;\n  right: 0px;\n  top: 27px;\n}\n#remembear-button[data-v-224c93ed] {\n  border: solid 1px #edaf19;\n  background-color: #ffffff;\n  color: #dcb150;\n  font-size: 15px;\n  text-align: center;\n  padding-top: 4px;\n  cursor: pointer;\n\n  width: 130px;\n  height: 24px;\n  border-radius: 2px;\n\n  margin-left: 38px;\n  margin-top: 12px;\n}\n", ""]);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_remembear_prompt_vue_vue_type_style_index_0_id_224c93ed_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22);
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_remembear_prompt_vue_vue_type_style_index_0_id_224c93ed_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_remembear_prompt_vue_vue_type_style_index_0_id_224c93ed_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_remembear_prompt_vue_vue_type_style_index_0_id_224c93ed_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// module
exports.push([module.i, "\n#double-tunnel-prompt-container[data-v-267f64e0] {\n  height: 215px;\n  background: #fafafa;\n  position: relative;\n  border-top: 1px solid #e5e2dc;\n  font-size: 13px;\n  color: #97948e;\n  padding-left: 15px;\n}\n#prompt-text[data-v-267f64e0] {\n  width: 145px;\n  margin-top: 20px;\n  margin-bottom: 20px;\n}\n.button[data-v-267f64e0] {\n  display: inline-block;\n  cursor: pointer;\n  width: 140px;\n  height: 24px;\n  border-radius: 2px;\n\n  border: solid 1px #edaf19;\n  background-color: #ffffff;\n  color: #dcb150;\n  font-size: 15px;\n\n  text-align: center;\n  padding-top: 4px;\n\n  margin-bottom: 22px;\n}\n#checkbox-label[data-v-267f64e0] {\n  font-size: 12px;\n}\n#crowded-bear[data-v-267f64e0] {\n  position: absolute;\n  top: 16px;\n  left: 170px;\n}\n", ""]);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_double_tunnel_warning_prompt_vue_vue_type_style_index_0_id_267f64e0_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23);
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_double_tunnel_warning_prompt_vue_vue_type_style_index_0_id_267f64e0_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_double_tunnel_warning_prompt_vue_vue_type_style_index_0_id_267f64e0_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_double_tunnel_warning_prompt_vue_vue_type_style_index_0_id_267f64e0_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_email_not_confirmed_prompt_vue_vue_type_style_index_0_id_359c31af_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_review_prompt_vue_vue_type_style_index_0_id_26268497_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_twitter_promo_prompt_vue_vue_type_style_index_0_id_6fdd2dce_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_prompt_box_helper_vue_vue_type_style_index_0_id_438df617_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_out_of_data_prompt_vue_vue_type_style_index_0_id_5b1020bc_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_connection_map_vue_vue_type_style_index_0_id_525d97d2_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_map_line_vue_vue_type_style_index_0_id_608a952c_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_map_tunnel_vue_vue_type_style_index_0_id_caad0744_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_map_origin_vue_vue_type_style_index_0_id_b4a9e7c8_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_map_background_vue_vue_type_style_index_0_id_3dc4e1b8_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_top_row_vue_vue_type_style_index_0_id_40f823ba_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_settings_button_vue_vue_type_style_index_0_id_5f809d18_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_country_and_status_vue_vue_type_style_index_0_id_a1c68cd2_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_on_off_toggle_vue_vue_type_style_index_0_id_e7493d10_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_expand_collapse_toggle_vue_vue_type_style_index_0_id_15af3d99_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// module
exports.push([module.i, "\n@font-face {\n  font-family: 'OpenSans';\n  font-style: normal;\n  font-weight: 400;\n  src: url(" + escape(__webpack_require__(148)) + ") format('woff2');\n  unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2212, U+2215;\n}\n@font-face {\n  font-family: 'OpenSans';\n  font-style: normal;\n  font-weight: 600;\n  src: url(" + escape(__webpack_require__(147)) + ") format('woff2');\n  unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2212, U+2215;\n}\n#app {\n  font-family: 'OpenSans';\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n\n  margin: 0px;\n  width: 260px;\n}\n", ""]);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_app_vue_vue_type_style_index_0_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(39);
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_app_vue_vue_type_style_index_0_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_error_screen_vue_vue_type_style_index_0_id_0120c23a_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(59), __webpack_require__(14)))
